...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>please search in @atozmoviesflix group 😁 !</b>")
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        ...
        InlineKeyboardButton("🔈Cʜᴀɴɢᴇ Lᴀɴɢᴜᴀɢᴇ ", callback_data=f"select_lang#{req}")
    ])
    btn.insert(0, [
...
async def language_check(bot, query):
    ...
    if files:
        ...
        btn.insert(0, [
            InlineKeyboardButton("! Sᴇɴᴅ Aʟʟ Tᴏ PM !", url=f"https://t.me/{temp.U_NAME}"),
            InlineKeyboardButton("🔈Cʜᴀɴɢᴇ Lᴀɴɢᴜᴀɢᴇ ", callback_data=f"select_lang#{userid}")
        ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              ...
                              InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/popcornpanda")
                             ]
                            ]
                        )
                    )
        ...
        ident, from_user = query.data.split("#")
        btn = [[
                InlineKeyboardButton("🔈Cʜᴀɴɢᴇ Lᴀɴɢᴜᴀɢᴇ ", callback_data=f"upalert#{from_user}")
              ]]
        btn2 = [[
                 InlineKeyboardButton("Vɪᴇᴡ Sᴛᴀᴛᴜs", url=f"{query.message.link}")
               ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/popcornpanda")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("! Sᴇɴᴅ Aʟʟ Tᴏ PM !", url=f"https://t.me/{temp.U_NAME}"),
        InlineKeyboardButton("🔈Cʜᴀɴɢᴇ Lᴀɴɢᴜᴀɢᴇ ", callback_data=f"select_lang#{message.from_user.id}")
    ])
